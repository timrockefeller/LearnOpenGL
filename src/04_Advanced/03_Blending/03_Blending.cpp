...
int main(int argc, char const* argv[]) {
    ...
    grassTexture.setUnit(2);

    Shader shader("./src/04_Advanced/03_Blending/vertex.vs",
                  "./src/04_Advanced/03_Blending/frag_depth.fs"),
        grassShader("./src/04_Advanced/03_Blending/vertex.vs",
                    "./src/04_Advanced/03_Blending/frag_alphatex.fs");
    ...
    op << Glfw::getInstance()->_startOp << [&]() {
        ...
        grassShader.setMat4f("view", view);
        grassShader.setMat4f("projection", projection);
        // floor
